...
<script>
    ...
    function viewLeave(id){ alert('View leave '+id);} function deleteLeave(id){ if(confirm('Delete leave '+id+'?')){ showLoading(); setTimeout(()=>{ alert('Deleted'); hideLoading(); refreshTable(); },900);} }
    function saveLeave(){ alert('Applied'); document.getElementById('addLeaveModal').querySelector('.btn-close')?.click(); refreshTable(); }
</script>
