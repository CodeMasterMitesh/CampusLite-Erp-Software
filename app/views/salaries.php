...
<script>
    ...
    function viewSalary(id){ alert('View salary '+id);} function deleteSalary(id){ if(confirm('Delete salary '+id+'?')){ showLoading(); setTimeout(()=>{ alert('Deleted'); hideLoading(); refreshTable(); },900);} }
    function generateSalary(){ alert('Generated'); document.getElementById('generateSalaryModal').querySelector('.btn-close')?.click(); refreshTable(); }
</script>
